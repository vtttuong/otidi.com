...
import { productStatus } from "features/post-form/post-form-update";
    ...
    return (
        <div>
            <Row>
                <Col xs={6} sm={6} md={6} lg={6}>
                    ...
                    <Input
                        ...
                        label="automaker"
                        name="automaker"
                        value={state.additionalInfo.automaker ? state.additionalInfo.automaker : ''}
                        onChange={(e) => {
                            dispatch({
                                type: "HANDLE_ON_CHANGE_ADDITIONAL_DATA",
                                payload: { value: e.target.value, field: e.target.name, key: "additionalInfo" },
                            });
                        }}
                ...
                <Col xs={6} sm={6} md={6} lg={6}>
                    ...
                    <Input
                        ...
                        label="Vehicles"
                        name="vehicles"
                        value={state.additionalInfo.vehicles ? state.additionalInfo.vehicles : ''}
                        onChange={(e) => {
                            dispatch({
                                type: "HANDLE_ON_CHANGE_ADDITIONAL_DATA",
                                payload: { value: e.target.value, field: e.target.name, key: "additionalInfo" },
            ...
            <Row>
                ...
                <Col xs={6} sm={6} md={6} lg={6}>
                    <Label>
                        <FormattedMessage id="productStatus" defaultMessage={'Product Status'} />
                    </Label>
                    <div style={{ minWidth: '100%' }}>
                        <Select
                            ...
                            value={productStatus[state.indexOptionStatus]}
                            onChange={(data) => {
                                dispatch({
                                    type: "HANDLE_ON_SELECT_CHANGE",
                                    payload: { value: data.value, field: "productStatus" },
                                });
                                dispatch({
                                    type: "HANDLE_ON_SELECT_CHANGE",
            ...
            <Row>
                <Col xs={6} sm={6} md={6} lg={6}>
                    ...
                    <Input
                        ...
                        name="rangeOfVehicle"
                        value={state.additionalInfo.rangeOfVehicle ? state.additionalInfo.rangeOfVehicle : ''}
                        onChange={(e) => {
                            dispatch({
                                type: "HANDLE_ON_CHANGE_ADDITIONAL_DATA",
                                payload: { value: e.target.value, field: e.target.name, key: "additionalInfo" },
                ...
                <Col xs={6} sm={6} md={6} lg={6}>
                    ...
                    <Input
                        ...
                        label="Capacity"
                        name="capacity"
                        value={state.additionalInfo.capacity ? state.additionalInfo.capacity : ''}
                        onChange={(e) => {
                            dispatch({
                                type: "HANDLE_ON_CHANGE_ADDITIONAL_DATA",
                                payload: { value: e.target.value, field: e.target.name, key: "additionalInfo" },
            ...
            <Row>
                <Col xs={6} sm={6} md={6} lg={6}>
                    ...
                    <Input
                        ...
                        name="kilometersGone"
                        value={state.additionalInfo.kilometersGone ? state.additionalInfo.kilometersGone : ''}
                        onChange={(e) => {
                            dispatch({
                                type: "HANDLE_ON_CHANGE_ADDITIONAL_DATA",
                                payload: { value: e.target.value, field: e.target.name, key: "additionalInfo" },
                ...
                <Col xs={6} sm={6} md={6} lg={6}>
                    ...
                    <Input
                        ...
                        label="Warranty"
                        name="isWarranty"
                        value={state.additionalInfo.isWarranty ? state.additionalInfo.isWarranty : ''}
                        onChange={(e) => {
                            dispatch({
                                type: "HANDLE_ON_CHANGE_ADDITIONAL_DATA",
                                payload: { value: e.target.value, field: e.target.name, key: "additionalInfo" },
...
const FormAdditional: React.FC<any> = ({
    categorySlug,
}) => {
    return (
        <div style={{ minWidth: '100%' }}>
            {switchRender(categorySlug)}
        </div>
    );
};
