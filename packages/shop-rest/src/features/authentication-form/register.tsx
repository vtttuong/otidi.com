  ...
  async function registerCallback(e) {
    if (typeof window !== "undefined") {
      ...
      const res = await fetch(
        process.env.NEXT_PUBLIC_LARAVEL_API_URL + "/api/client/v1/register",
        options
      );
    ...
    <Wrapper>
      <Container>
        ...
        {errorPass && errorPass.length > 0 ? (
          ...
          >
            <FormattedMessage id="errorConfirmPass" defaultMessage="Error confirm password" />
          </span>
        ) : null}
        ...
        {errorField && errorField.length > 0 ? (
          ...
          >
            <FormattedMessage id="errorRegisterField" defaultMessage="Check all field required !" />
          </span>
        ) : null}
        ...
        {errorEmailServe && errorEmailServe.length > 0 ?
          (
            ...
            >
              <FormattedMessage id="errorRegister" defaultMessage={errorEmailServe} />
            </span>
          )
          : null}
        {errorPassServe && errorPassServe.length > 0 ?
          (
            ...
            >
              <FormattedMessage id="errorRegister" defaultMessage={errorPassServe} />
            </span>
          )
          : null}
        ...
        <Button variant='primary' size='big' width='100%' type='submit' loading={loading}
