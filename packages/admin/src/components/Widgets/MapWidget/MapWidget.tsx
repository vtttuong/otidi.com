...
import {
  ...
  MapLengendBox,
  MapLengendBoxSingle,
  MapLengendColor, MapLengendTitle,
  MapLengendValue,
  ProgressBarTitleWrapper, Progressbox,
  ProgressNumber, ProgressSingle,
  ProgressTitle, TopPart,
  TotalValueBox
    ...
    <Box>
      <TopPart>
        <TotalValueBox>
          ...
          <MapLengendValue>
            {parseInt(data.reduce((a, { value }) => a + value, 0)).toLocaleString()}
          </MapLengendValue>
        </TotalValueBox>
